...
def _fixed_options(key: str) -> list[dict]:
    options = {
        ...
        "gnssPrecision": [
            ("Standard positioning — meter-level accuracy", "standard"),
            ("High-precision positioning — centimeter-level RTK", "cm"),
            ("Accuracy not yet defined / open", "No preference"),
        ],
        "gnssDualBand": [
            ("Single-band L1 is sufficient", "L1 sufficient"),
            ("Dual-band L1 + L5 is required", "L1 + L5 required"),
            ("No preference / not sure", "No preference"),
        ],
        "genericInterface": [
            ("I²C", "i2c"),
...
QUESTION_TEXT = {
    ...
    "gnssPrecision": "What positioning accuracy class is required for your application?",
    "gnssDualBand": "Which GNSS receiver band capability is required?",
