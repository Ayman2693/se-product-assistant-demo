...
function localizeQuestion(
  ...
  const exact: Record<string, string> = {
    "Hello, I am the SE Product Assistant. How can I help you?<br><span class='botHint'>Briefly describe the application, component, or technical requirement you are looking for.</span>":
